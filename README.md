...
Upload the file apn-web_1.0.3_all.ipk/apk to the /tmp directory

Open a terminal (via PuTTY or WinSCP) and run:

<pre>opkg install /tmp/apn-web_1.0.3_all.ipk/apk</pre>

# Method 2: SCP (Linux/macOS)

Copy the file to your router:

<pre>scp apn-web_1.0.3_all.ipk/apk
  root@192.168.1.1:/tmp/</pre>
